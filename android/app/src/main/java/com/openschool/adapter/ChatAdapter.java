...
import com.openschool.activity.ChatActivity;
...
import com.openschool.utils.UiUtils;
import com.openschool.utils.ValidationUtils;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.NewMessageViewHolder> implements
    ...
    private void fillAvatarHolder(NewMessageViewHolder holder, QBChatMessage chatMessage) {
        ...
        QBUser user = ((MainApplication) context).getQBUsersHolder().getUserById(chatMessage.getSenderId());
    ...
    private String getSenderName(QBChatMessage chatMessage) {
        QBUser sender = ((MainApplication) context).getQBUsersHolder().getUserById(chatMessage.getSenderId());
        String fullName = "";
    ...
    private boolean isReadByCurrentUser(QBChatMessage chatMessage) {
        Integer currentUserId = ((MainApplication) context).getChatHelper().getCurrentUser().getId();
    ...
    private boolean isIncoming(QBChatMessage chatMessage) {
        QBUser currentUser = ((MainApplication) context).getChatHelper().getCurrentUser();
