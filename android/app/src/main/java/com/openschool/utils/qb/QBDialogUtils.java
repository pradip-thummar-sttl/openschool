package com.openschool.utils.qb;
...
public class QBDialogUtils {
    ...
    private static void logUsersByIds(Context context, List<Integer> users) {
        for (Integer id : users) {
            QBUser user = ((MainApplication) context).getQBUsersHolder().getUserById(id);
    ...
    public static String getDialogName(Context context, QBChatDialog dialog) {
        if (dialog.getType().equals(QBDialogType.GROUP)) {
            ...
            QBUser user = ((MainApplication) context).getQBUsersHolder().getUserById(opponentId);
            if (user != null) {
