...
public class ValidationUtils {
    ...
    private static boolean isEnteredTextValid(EditText editText, int maxLength, boolean checkLogin) {
    ...
    public static boolean isLoginValid(EditText editText) {
        return isEnteredTextValid(editText, MAX_LOGIN_LENGTH, true);
    }

    public static boolean isFullNameValid(EditText editText) {
        return isEnteredTextValid(editText, MAX_FULLNAME_LENGTH, false);
    }
