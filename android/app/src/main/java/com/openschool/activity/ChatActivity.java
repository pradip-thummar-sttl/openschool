...
import com.openschool.adapter.AttachmentPreviewAdapter;
...
import com.openschool.utils.PermissionsChecker;
import com.openschool.utils.SystemPermissionsHelper;
import com.openschool.utils.ToastUtils;
import com.openschool.utils.qb.QBDialogUtils;
import com.openschool.utils.qb.VerboseQbChatConnectionListener;
import com.openschool.views.AttachmentPreviewAdapterView;
...
public class ChatActivity extends BaseActivity implements OnMediaPickedListener, QBMessageStatusListener {
    ...
    public static final String EXTRA_CURRENT_NAME = "currentname";
...
//        }
    ...
    private void reloginToChat() {
        ...
        System.out.println("KDKDKD: " + getSharedPrefsHelper().getQbUser() + "\n" + currentUser);
