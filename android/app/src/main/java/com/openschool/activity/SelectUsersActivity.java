...
import com.openschool.adapter.CheckboxUsersAdapter;
import com.openschool.adapter.ScrollViewWithMaxHeight;
...
public class SelectUsersActivity extends BaseActivity {
    ...
    private void initUi() {
        ...
        // TODO Chips: 1/1 To enable functionality of chips with selected Users uncomment this string:
        //scrollView.setVisibility(View.VISIBLE);

        chipGroup = findViewById(R.id.chips);
        tvNotFound = findViewById(R.id.tv_no_users_found);
        usersAdapter = new CheckboxUsersAdapter(this, new ArrayList<>());
        ...
        usersListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                for (QBUser user : usersAdapter.getSelectedUsers()) {
                    ...
                    runOnUiThread(() -> scrollView.fullScroll(ScrollView.FOCUS_DOWN));
                }
