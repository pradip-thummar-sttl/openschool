    ...
    return (
        <View style={PAGESTYLE.mainPage}>
            <Sidebar
                ...
                hide={() => action(!isHide)}
                navigateToDashboard={() => { setTeacherLessonDetail(false); setSelectedIndex(0) }}
                navigateToTimetable={() => { setTeacherLessonDetail(false); setSelectedIndex(1) }}
                navigateToLessonAndHomework={() => { setTeacherLessonDetail(false); setSelectedIndex(2) }} />
            {
