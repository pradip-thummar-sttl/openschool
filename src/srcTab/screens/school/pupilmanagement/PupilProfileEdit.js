...
const PupilProfileEdit = (props) => {
  ...
  const loadTeacher = () => {
    Service.get(
      `${EndPoints.Teacherdownbyschoolid}/${User.user.UserDetialId}`,
      (res) => {
        if (res.code == 200) {
  ...
  const saveProfile = () => {
    ...
    console.log(
      "THIS IS URL `${EndPoints.PupilUpdate}/${props?.selectedPupil?.PupilId}`",
      `${EndPoints.PupilUpdate}/${props?.selectedPupil?.PupilId}`
    );
  ...
  const uploadProfile = (pupilId) => {
    ...
    Service.postFormData(
      data,
      `${EndPoints.PupilUploadProfile}/${pupilId}`,
      (res) => {
        if (res.code == 200) {
          setLoading(false);
  ...
  const selectTeacher = (item, index, isCheck) => {
    ...
    console.log(
      "hello dude select and remove array is",
      selectTech,
      removeTech
    );
  };
  ...
  const teacherDropDown = () => {
    return (
      <View
        style={[
          PAGESTYLE.commonInputGrayBack,
          { marginBottom: hp(2), width: "100%" },
        ]}
      >
          ...
          >
            <View style={PAGESTYLE.managementDetail}>
              <View style={[PAGESTYLE.managementBlockTop]}>
                <TopBackImg
                  style={PAGESTYLE.managementopImage}
                  height={hp(20)}
                  width={"100%"}
                />
                <View
                  style={[
                    PAGESTYLE.TeacherProfileMainView,
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      source={{
                        uri: !isProfileUri.uri
                          ? baseUrl + props?.selectedPupil?.ProfilePicture
                          : isProfileUri.uri,
                      }}
                    />
                    <View style={PAGESTYLE.editprofileStyl}>
                      <Ic_Edit
                        style={PAGESTYLE.pzEditIcon}
                        width={hp(1.7)}
                        height={hp(1.7)}
                      />
                    </View>
              ...
              <View style={PAGESTYLE.innerView}>
                <View>
                  ...
                  <View style={{ marginTop: hp(2) }}>
                    <Text style={PAGESTYLE.fieldInputLabel}>
                      Parent's First Name
                    </Text>
                    <View style={[PAGESTYLE.field, PAGESTYLE.filedSpace]}>
                      <TextInput
                ...
                <View style={{ width: hp(70) }}>
                  <View style={{ marginTop: hp(2) }}>
                    ...
                    <TouchableOpacity
                      style={[PAGESTYLE.field, PAGESTYLE.filedSpace]}
                    ...
                    >
                      <View style={PAGESTYLE.SelectDateView}>
                        ...
                        <Text style={PAGESTYLE.dateTimetextdummy}>
                          {isSelectedDate ? isSelectedDate : "Select Date"}
                        </Text>
                        <ArrowDown
