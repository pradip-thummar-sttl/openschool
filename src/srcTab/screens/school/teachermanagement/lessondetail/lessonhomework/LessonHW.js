...
var checkItem = [
  ...
  {
    ItemName:
      "Write a list of all the everyday items that come from the Amazon Rainforest",
    IsCheck: false,
  },
  {
    ItemName:
      "Write a short story about where those items come from in the the forest and what they mean to you.",
    IsCheck: false,
  },
  {
      ...
      <View style={[PAGESTYLE.blockSpaceBottom]}>
        ...
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <View
              style={[PAGESTYLE.checkBoxLabelLine, { alignItems: "center" }]}
            >
              <CheckBox
            ...
            <View style={PAGESTYLE.teacherDetailLeft}>
              <View style={PAGESTYLE.timedateGrp}>
                  ...
                  <View style={PAGESTYLE.toggleBox}>
                    <View style={PAGESTYLE.toggleGrpBox}>
                      ...
                      <ToggleSwitch
                        ...
                        onToggle={(isOn) => switchOnOff(isOn)}
                      />
                    </View>
                  </View>
                </View>
                <View style={[PAGESTYLE.duedateBox, PAGESTYLE.time]}>
                  <View
                    style={[
                      PAGESTYLE.subjectDateTimeHomework,
                      PAGESTYLE.dropDownSmallWrapNormal,
                    ]}
                  >
                    ...
                    <Calender
                      style={PAGESTYLE.calIconHomeWork}
                      height={hp(1.76)}
                      width={hp(1.76)}
                    />
                    <TouchableOpacity
                      onPress={() => showDatePicker()}
                      style={PAGESTYLE.subjectDateTimeHomework}
                    >
                      <View>
                    ...
                    <ArrowDown
                      style={PAGESTYLE.dropDownArrowdatetimehomeWork}
                      height={hp(1.51)}
                      width={hp(1.51)}
                    />
                  </View>
