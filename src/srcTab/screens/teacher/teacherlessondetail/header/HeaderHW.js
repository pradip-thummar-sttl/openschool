        ...
        <View style={styles.headerBarMainWhite}>
            <View style={styles.headerMain}>
                ...
                <View style={styles.headerRight}>
                    <Popuphomework updateFlag={props.updateFlag} hwBtnName={props.hwBtnName} isHomeworkLoading={props.isHomeworkLoading} onOpenPopup={() => props.onOpenPopup()} isVisible={props.isVisible} onClose={() => props.onClose()} setHomework={() => props.setHomework()} />
                    <TouchableOpacity
