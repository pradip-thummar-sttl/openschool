...
const TeacherLessonDetail = (props) => {
  ...
  const [isTLHomeWorkSubmittedDetail, setTLHomeWorkSubmittedDetail] = useState(
    false
  );
    ...
    <View style={PAGESTYLE.mainPage}>
      {isTLHomeWorkSubmittedDetail ? (
        <TLHomeWorkSubmittedDetail
          item={data}
          goBack={() => {
            setTLHomeWorkSubmittedDetail(false);
          }}
          onAlertPress={() => {
            props.onAlertPress();
          }}
        ...
        <ScreenAndCameraRecording
          goBack={() => {
            setScreenAndCameraRecording(false);
          }}
          onAlertPress={() => {
            props.onAlertPress();
          }}
              ...
              {tabIndex == 0 && (
                <View style={[PAGESTYLE.lessonstartButton]}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      setTLDetailEdit(true);
                    }}
                  >
                    <Text style={STYLE.commonButtonGreenDashboardSide}>
                      Edit Lesson
                    </Text>
                  </TouchableOpacity>
                </View>
                  ...
                  <TouchableOpacity style={PAGESTYLE.buttonGroup}>
                    <Menu style={PAGESTYLE.filterGroup}>
                      <MenuTrigger style={{ justifyContent: "center" }}>
                        <Text style={PAGESTYLE.commonButtonBorderedheader}>
                          By {filterBy}
                        </Text>
                        <FilterBlack
                          style={PAGESTYLE.filterIcon}
                          height={hp(1.74)}
                          width={hp(1.74)}
                        />
                      </MenuTrigger>
                      <MenuOptions style={PAGESTYLE.filterListWrap}>
                        <MenuOption style={PAGESTYLE.borderList}>
                          <TouchableOpacity
                            activeOpacity={opacity}
                            onPress={() => {
                              setFilterBy("Pupil Name");
                              setSelectedIndex(0);
                            }}
                          >
                            <View style={PAGESTYLE.filterList}>
                              <Text style={PAGESTYLE.filterListText}>
                                Pupil Name
                              </Text>
                              {selectedIndex == 0 ? (
            ...
            >
              {tabIndex == 0 ? (
                ...
                <TLHomeWork
                  ...
                  navigateScreeCamera={() => {
                    setScreenAndCameraRecording(true);
                  }}
                  navigateToVideoGallery={() => {
                    setTLVideoGallery(true);
                  }}
                ...
                <TLHomeWorkSubmitted
                  ...
                  navigateToDetail={(data) => {
                    setItem(data), setTLHomeWorkSubmittedDetail(true);
                  }}
