...
import { View, StyleSheet, Text, TouchableOpacity, H3, ScrollView, Image, ImageBackground, FlatList, SafeAreaView, ActivityIndicator, Platform } from "react-native";
...
const Pupillist = (props, { style }) => (
    <TouchableOpacity
        ...
        <View style={[PAGESTYLE.pupilData]}>
            ...
            <View style={PAGESTYLE.pupilProfile}>
                <Text style={[PAGESTYLE.pupilName, PAGESTYLE.yesText, { marginLeft: hp(1), color: props?.item?.LiveSession === true ? COLORS.dashboardPupilBlue : COLORS.yellowDark }]}>{props?.item?.LiveSession === true ? 'Yes' : 'No' }</Text>
            </View>
            <View style={PAGESTYLE.pupilProfile}>
