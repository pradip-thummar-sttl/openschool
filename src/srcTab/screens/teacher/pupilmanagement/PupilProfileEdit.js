...
const PupilProfileEdit = (props) => {
  ...
  useEffect(() => {
    ...
    var SelTeacher = [];
    profileData?.selectedPupil?.TeacherList.forEach((element) => {
    ...
    Service.get(
      ...
      (res) => {
        if (res.flag) {
          ...
          Service.post(
            data,
            `${EndPoints.PupilUpdate}/${profileData.PupilId}`,
            (res) => {
              if (res.code == 200) {
  ...
  const uploadProfile = (updatedData) => {
    ...
    Service.postFormData(
      data,
      `${EndPoints.PupilUploadProfile}/${profileData.PupilId}`,
      (res) => {
        if (res.code == 200) {
          setLoading(false);
          showMessageWithCallBack(MESSAGE.profileUpdated, () => {});
        ...
        <KeyboardAwareScrollView>
          <ScrollView showsVerticalScrollIndicator={false}>
            <View>
                  ...
                  <ImageBackground style={PAGESTYLE.managementopImage}>
                    ...
                    <View style={[PAGESTYLE.thumbTopUser]}>
                      ...
                      >
                        ...
                        <View style={PAGESTYLE.pzEditIcon}>
                          <Ic_Edit
                            style={PAGESTYLE.pzEditIconIcon}
                            width={hp(2.25)}
                            height={hp(2.25)}
                          />
                        </View>
              ...
              <View
                style={[
                  PAGESTYLE.loginAccountForm,
                  PAGESTYLE.formSpace,
                  PAGESTYLE.formTopSpace,
                ]}
              >
                <View>
