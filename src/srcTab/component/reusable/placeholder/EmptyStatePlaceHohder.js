...
const EmptyStatePlaceHohder = (props) => {
    return (
        <View style={PAGESTYLE.managementBlankImgWrap}>
            ...
            {props.holderType == 1 ?
                <NoLessonsHomework style={PAGESTYLE.blankPageImage} height={hp(20.55)} width={hp(20.55)} />
                :
                props.holderType == 2 ?
                    <NotSentGlobalMessages style={PAGESTYLE.blankPageImage} height={hp(20.55)} width={hp(20.55)} />
                    :
                    props.holderType == 3 ?
                        <NoLessonEventYet style={PAGESTYLE.blankPageImage} height={hp(20.55)} width={hp(20.55)} />
                        :
                        props.holderType == 4 ?
                            <NoPupil style={PAGESTYLE.blankPageImage} height={hp(20.55)} width={hp(20.55)} />
                            :
                            props.holderType == 5 ?
