...
const Avatar = (prop) => {
  ...
  const refresh = () => {
    Service.get(
      `${EndPoints.GetPupilRewards}/${User.user.UserDetialId}`,
      (res) => {
  ...
  const saveMyAvtar = () => {
    setTimeout(() => {
      ...
      Service.post(
        data,
        `${EndPoints.UpdateAvtar}/${User.user.UserDetialId}`,
        (res) => {
  ...
  const openNotification = () => {
    ...
    prop.navigation.navigate("NotificationDrawer", {
      onGoBack: () => refresh(),
    });
  };
    ...
    <View>
      ...
      <View style={Styles.mainView}>
        <View style={Styles.yellowView}>
          ...
          <Text style={Styles.headText}>{points} points</Text>
        </View>
          ...
          {isLoading == false ? (
            ...
            >
              {currentSelectedHair == 0 ? (
                <Image
                  source={{
                    uri: baseUrl + hairAvtar[currentSelectedHair].Images,
                  }}
                  style={{
                    width: hp(13),
                    height: hp(13),
              ...
              <Image
                source={{
                  uri: baseUrl + [colourAvtar[currentSelectedColour].Images],
                }}
                style={{
                  width: hp(20),
                  height: hp(35),
              ...
              <Image
                source={{
                  uri: baseUrl + eyesAvtar[currentSelectedEyes].Images,
                }}
                style={{
                  width: hp(8),
                  height: hp(8),
              ...
              <Image
                source={{
                  uri: baseUrl + mouthAvtar[currentSelectedMouth].Images,
                }}
                style={{
                  width: hp(8),
                  height: hp(8),
            ...
            <FlatList
              ...
              renderItem={({ item, index }) => {
                return (
                  ...
                  >
                    <Image
                      source={{ uri: baseUrl + item.Images }}
                      style={{
                        width: hp(9),
                        height: hp(9),
                        resizeMode: "contain",
