...
const SchoolHeaderProfile = (props) => {
    return (
        <View style={styles.headerMain}>
            <View style={styles.menuIconWithTitle}>
                ...
                <Text style={styles.mainTitle} numberOfLines={1}>My Profile</Text>
            </View>
            <View>
                <TouchableOpacity
                    ...
                    <Ic_Edit style={styles.massagesIcon} height={hp(2.20)} width={hp(2.20)}/>
...
export default SchoolHeaderProfile;
