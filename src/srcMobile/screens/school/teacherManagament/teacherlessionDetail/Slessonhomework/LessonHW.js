        ...
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <View style={PAGESTYLE.checkBoxLabelLine}>
              ...
              <Text
                numberOfLines={1}
                style={[PAGESTYLE.checkBoxLabelText, { width: wp(75) }]}
              >
                {item.ItemName}
              </Text>
              <TouchableOpacity
        ...
        <View style={PAGESTYLE.containerWrap}>
          <View style={PAGESTYLE.teacherDetailLeft}>
            ...
            <View style={PAGESTYLE.requirementofClass}>
              ...
              <View style={PAGESTYLE.checkBoxGroup}>{itemCheckListView()}</View>
            </View>
          </View>
          <View style={PAGESTYLE.rightSideBar}>
            <View style={PAGESTYLE.fileBoxGrpWrap}>
              ...
              <Text style={PAGESTYLE.rightBlockText}>
                Drop links, videos, or documents here or find relevant materials
                with our clever AI
              </Text>
            </View>
            <TouchableOpacity
              ...
              {materialArr.length != 0
                ? materialArr.map((item, index) => {
                    return (
                      ...
                      >
                        <Text
                          style={{ ...PAGESTYLE.fileName, width: wp(75) }}
                          numberOfLines={1}
                        >
