      ...
      <ScrollView contentContainerStyle={PAGESTYLE.containerWrap}>
          ...
          <View style={[PAGESTYLE.dateWhiteBoard, PAGESTYLE.grp]}>
            ...
            <View style={PAGESTYLE.subjectDateTime}>
              <View style={PAGESTYLE.alignRow}>
                ...
                <Text
                  numberOfLines={1}
                  style={[PAGESTYLE.datetimeText, { width: wp(50) }]}
                >
          ...
          <View style={PAGESTYLE.requirementofClass}>
            ...
            <FlatList
              ...
              renderItem={({ item, index }) => (
                <View
                  style={[PAGESTYLE.checkBoxLabelLine, { paddingVertical: 5 }]}
                >
                  <TickMarkBlue
                  ...
                  <Text
                    numberOfLines={1}
                    style={[PAGESTYLE.lessonPointText, { width: wp(82) }]}
                  >
                    {item.ItemName}
                  </Text>
                </View>
        ...
        <View style={PAGESTYLE.rightSideBar}>
              ...
              <FlatList
                ...
                renderItem={({ item, index }) => (
                  ...
                  >
                    <Text
                      numberOfLines={1}
                      style={[PAGESTYLE.fileName, { width: wp(70) }]}
                    >
                      {item.originalname}
                    </Text>
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  Download(props.lessonData.RecordingList[0], (res) => {
              ...
              >
                ...
                <Text
                  numberOfLines={1}
                  style={[PAGESTYLE.videoLinkText, { width: wp(70) }]}
                >
                  {props.lessonData.RecordingList[0].originalname}
                </Text>
              </TouchableOpacity>
            </View>
          )}
          ...
          {videoMaterial.length > 0 ? (
            <>
              <Text style={PAGESTYLE.requireText}>Recommended Video</Text>
