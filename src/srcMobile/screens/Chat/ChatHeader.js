    ...
    return (
        <View style={styles.headerBarMainWhite}>
            ...
            {/* <Image style={styles.arrow} source={Images.backArrow} /> */}
                <Text style={styles.mainTitle}><TouchableOpacity style={{justifyContent:'center'}} onPress={() => props.goBack()}><BackArrow style={styles.closeIcon} height={hp(2)} width={hp(2.4)} /></TouchableOpacity> {'props.title'}</Text>
