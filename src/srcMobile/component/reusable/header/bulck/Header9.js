...
const HeaderWhite = (props) => {
    return (
        <View style={styles.headerBarMainWhite}>
            ...
            <Text style={styles.mainTitle}><TouchableOpacity><BackArrow style={styles.arrow} height={hp(2.34)} width={hp(2.34)} /></TouchableOpacity> Common Title - <Text style={styles.date}>14/09/2020</Text></Text>
