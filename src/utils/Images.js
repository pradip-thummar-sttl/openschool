const Images = {
    ...
    schoolLoginIcon: require('../assets/images/school-icon-2.png'),
    teacherLoginIcon: require('../assets/images/teacher-icon2.png'),
    pupilLoginIcon: require('../assets/images/pupil-icon2.png'),
