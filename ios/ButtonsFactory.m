...
const CGRect kkDefRect = {0, 0, 56, 76};
const CGRect kkDefDeclineRect = {0, 0, 96, 44};
const CGRect kkDefCircleDeclineRect = {0, 0, 44, 44};
...
+ (CustomButton *)videoEnable {
    CustomButton *button = [self buttonWithFrame:kkDefRect
