...
export default StyleSheet.create({
    ...
    commonButtonGreenDashboardSide: {
        ...
        overflow: 'hidden',
        textAlign: 'center',
        paddingTop: Platform.OS == 'android' ? hp(1.9) : hp(1.21),
        paddingBottom: Platform.OS == 'android' ? hp(1.5) : hp(1.21),
        paddingLeft: Platform.OS == 'android' ? hp(9) : hp(4.94),
        paddingRight: Platform.OS == 'android' ? hp(9) : hp(4.94),
        alignSelf: 'center',
        shadowColor: COLORS.black,
        shadowOffset: {width: 0,height: 50,},
        shadowOpacity: 0.16,
    ...
    commonButtonBordered: {
        ...
        overflow: 'hidden',
        textAlign: 'center',
        paddingTop: Platform.OS == 'android' ? hp(2) : hp(1.21),
        paddingLeft: Platform.OS == 'android' ? hp(9) : hp(4.94),
        paddingRight: Platform.OS == 'android' ? hp(9) : hp(4.94),
        paddingBottom: Platform.OS == 'android' ? hp(1.5) : hp(1.21),
        alignSelf: 'center',
